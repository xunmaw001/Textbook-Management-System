<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='jiaocaiguanli'"  label='教材管理员姓名' prop="jiaocaiguanliName">
               <el-input v-model="ruleForm.jiaocaiguanliName"  placeholder='教材管理员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='jiaocaiguanli'"  label='联系方式' prop="jiaocaiguanliPhone">
               <el-input v-model="ruleForm.jiaocaiguanliPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.jiaocaiguanliName)&& 'jiaocaiguanli'==this.flag){
                             this.$message.error('教材管理员姓名不能为空');
                             return
                         }

                         if((!this.ruleForm.jiaocaiguanliPhone)&& 'jiaocaiguanli'==this.flag){
