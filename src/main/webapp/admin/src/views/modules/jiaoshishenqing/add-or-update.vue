    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请编号" prop="jiaoshishenqingUuidNumber">
                       <el-input v-model="ruleForm.jiaoshishenqingUuidNumber"
                                 placeholder="申请编号" clearable  :readonly="ro.jiaoshishenqingUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="申请编号" prop="jiaoshishenqingUuidNumber">
                           <el-input v-model="ruleForm.jiaoshishenqingUuidNumber"
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请数量" prop="jiaoshishenqingNumber">
                       <el-input v-model="ruleForm.jiaoshishenqingNumber"
                                 placeholder="申请数量" clearable  :readonly="ro.jiaoshishenqingNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="申请数量" prop="jiaoshishenqingNumber">
                           <el-input v-model="ruleForm.jiaoshishenqingNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="课程" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" :disabled="ro.kechengTypes" placeholder="请选择课程">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="课程" prop="kechengValue">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.jiaoshishenqingYesnoTypes" label="申请状态" prop="jiaoshishenqingYesnoTypes">
                        <el-input v-model="ruleForm.jiaoshishenqingYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.jiaoshishenqingYesnoText" label="申请结果" prop="jiaoshishenqingYesnoText">
                        <span v-html="ruleForm.jiaoshishenqingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                jiaoshiForm: {},
                ro:{
                    jiaoshishenqingUuidNumber: false,
                    jiaocaiId: false,
                    jiaoshiId: false,
                    jiaoshishenqingNumber: false,
                    kechengTypes: false,
                    banjiTypes: false,
                ...
                ruleForm: {
                    jiaoshishenqingUuidNumber: new Date().getTime(),
                    jiaocaiId: '',
                    jiaoshiId: '',
                    jiaoshishenqingNumber: '',
                    kechengTypes: '',
                    banjiTypes: '',
                    jiaoshishenqingYesnoTypes: '',
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaoshishenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiaoshishenqingYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiaoshishenqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiaoshishenqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
